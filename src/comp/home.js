...
import TestimonialImage from '../image/pro.jpg';
import TestimonialImage1 from '../image/slide-1.webp'; 
...
const Home = ({ addtocart }) => {
  ...
  return (
    <div className='home'>
      <div className='top_banner' style={{ backgroundImage: `url(${TestimonialImage1})`}}>
